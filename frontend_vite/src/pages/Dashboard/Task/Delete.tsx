...
import { type TaskDeleteModalProps } from "./Interface";

export function TaskDelete({ isOpen, onClose, dataDelete }: TaskDeleteModalProps) {
    ...
    mutationFn: (ids: string[]) => deleteTask({ id: ids }), 
                            ...
                            <div className="bg-white dark:bg-slate-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <DialogTitle as="h3" className="text-base font-semibold dark:text-gray-200">
                                        Hapus { dataDelete?.length } Tugas?
                                    </DialogTitle>
                                    <div className="mt-2">
                                    <p className="text-sm text-gray-400">
                                        Tugas berikut akan dihapus permanen.
                                    </p>
                                    </div>
                                </div>
                                </div>
