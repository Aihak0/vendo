...
export default function SignInForm() {
  ...
  useEffect(() => {
    ...
    if (user && profile) {
      if (profile.role === 'admin') {
        ...
        navigate('/teknisi/dashboard', { replace: true });
      }
    }
  ...
  return (
    <div className=" p-10 bg-white dark:bg-slate-800 rounded-xl shadow-md mx-auto w-120">
                ...
                <div className="space-y-6">
                  ...
                  <div className="mb-15">
                    ...
                    <div className="relative">
                        ...
                        <span
                          ...
                          >
                            {showPassword ? (
                              <EyeIcon className="text-gray-700 dark:text-gray-400 size-5" />
                            ) : (
                              <EyeClosed className="text-gray-700dark:text-gray-400 size-5" />
                            )}
                        </span>
                  ...
                  {/* <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <input id="default-checkbox" type="checkbox" checked={isChecked} onChange={(e) => setIsChecked(e.target.checked)} className="w-4 h-4 border border-default-medium rounded-xs bg-neutral-secondary-medium focus:ring-2 focus:ring-brand-soft"></input>
                  ...
                  <div>
                    ...
                    type="submit"
                    disabled={loading}
                    className="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition disabled:bg-gray-400 dark:disabled:bg-gray-700">
